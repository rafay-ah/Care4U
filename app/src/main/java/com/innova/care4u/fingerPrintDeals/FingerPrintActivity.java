...
public class FingerPrintActivity extends AppCompatActivity {
   ...
   public static Context context;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        /// for actual biometric verification using device fingerprint sensor
        ...
        // Simulation Code -- if there is no fingerprint in device
        ...
        }); // CODE TO SIMULATE THE BIOMETRIC VERIFICATION ENDS HERE
    }

    void doFailure(Context activity_context) {
    ...
    public void fingerPrintRecognized(Context activity_context)
    {
